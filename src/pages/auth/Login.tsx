...
function Login(){
    ...
    return(
        <div>
            <div className="p-10">
            <div className="max-w-[600px] p-8 shadow-xl rounded-lg mx-auto bg-fuchsia-300">
                ...
                <form onSubmit={submit}>
                    ...
                    <div className="mt-8">
                        <button type="submit" className="bg-fuchsia-800 text-white px-4 py-2 rounded-lg w-full hover:bg-gray-950">Login</button>
                    </div>
                </form>
            </div>
