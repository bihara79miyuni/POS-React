        ...
        <div>
            <div className="container mx-auto pt-5 pb-5 font-bold">
                ...
                <div className="bg-fuchsia-300">
                    <Link to="/" className="relative bg-white-800 p-1 text-blue-900 hover:text-black focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800 focus:outline-hidden px-10 py-10">Home</Link>
